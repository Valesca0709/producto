...
import org.springframework.data.jpa.repository.Query; // ✅ NUEVO: Import para la consulta personalizada
...
public interface ProductoSucursalRepository extends JpaRepository<ProductoSucursal, Integer> {
   ...
   // ✅ CORRECCIÓN: Reemplazamos el método anterior por una consulta explícita
